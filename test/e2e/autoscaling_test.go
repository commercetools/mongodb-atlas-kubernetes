...
var _ = Describe("Deploy deployment", Label("deployment-extra-ns"), func() {
	...
	DescribeTable("Namespaced operators working only with its own namespace with different configuration",
		...
		Entry("Advanced deployment with compute autoscaling", Label("ns-autoscaling"),
			model.NewTestDataProvider(
				"operator-ns-autoscaling",
				model.AProject{},
				model.NewEmptyAtlasKeyType().UseDefaulFullAccess(),
				[]string{"data/atlasdeployments_with_autoscaling.yaml"},
				[]string{},
				[]model.DBUser{},
				30000,
